...
salario = st.number_input('Salario Mensual',value=3500000,format="$0.1f")
...
monto = st.number_input('Monto del Crédito', value=5000000, label_visibility="visible",format="$0.1f")
